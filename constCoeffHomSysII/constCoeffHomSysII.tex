...
\draw[-stealth, red, thick](0,0)--(3,2)node[below right]{$\bf{x}$};

\draw[-stealth, blue, thick](0,0)--(3,-1)node[above right]{$\bf{u}$};

\draw[-,dashed](-3,-2)--(6,4)node[right]{$L$};

\node[right] at (2,0.3){$c_2>0$};
\node[right] at (0,-2){Positive Half-Plane};
\node[left] at (0,2){Negative Half-Plane};
\node[left] at (-2,0.3){$c_2<0$};
\end{tikzpicture}
\end{center}
...
\begin{center}
\geogebra{hyputxxw}{800}{600}
\end{center}

\begin{center}
\geogebra{cvma3cj2}{800}{600}
\end{center}
...
\begin{center}
\geogebra{ddxd8p76}{800}{600}
\end{center}

\begin{center}
\geogebra{pcbead3f}{800}{600}
\end{center}
