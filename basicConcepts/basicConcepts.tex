...
\begin{abstract}
In this section, we define ordinary differential equations and what it means for a function to be a solution to such an equation.
\end{abstract}
...
than one variable. For now we will consider only ordinary differential
equations, and we will just call them \dfn{differential equations}.
