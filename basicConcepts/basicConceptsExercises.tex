...
$y = \answer{-\frac{1}{2}x^2} + C$

\item $y'=-x \sin x$

$y = \answer{x*\cos{x}-\sin{x}} + C$

\item $y''=x \cos x$

$y = \answer{-x*\cos{x}+2\sin{x}} + C_1 x +C_2$

\item $y''=2xe^x$

$y = \answer{2*e^x*(x-2)} + C_1 x +C_2$

\item $y''=2x+\sin x+e^x$

$y = \answer{\frac{x^3}{3}-\sin{x}+e^x} + C_1 x +C_2$

\item $y'''=-\cos x$

$y = \answer{\sin{x}} + C_1 x^2 +C_2 x + C_3$

\item $y'''=-x^2+e^x$

$y = \answer{-\frac{x^5}{60}+e^x} + C_1 x^2 +C_2 x + C_3$

\item $y'''=7e^{4x}$

$y = \answer{\frac{7}{64}e^{4x}} + C_1 x^2 +C_2 x + C_3$
