...
$$y=\answer{\frac{1}{6}e^t-\frac{9}{2}e^{-t}+\frac{16}{3}e^{-2t}}$$
...
$$y=\answer{\frac{5}{3}\sin{t}-\frac{1}{3}\sin(2t)}$$
...
$$y=\answer{1-\cos(2t)+\frac{1}{2}\sin(2t)}$$
...
$$y=\answer{(3t+4)\sin{t}-(2t+6)\cos{t}}$$
...
$$y=\answer{e^t(-\cos{t}+\sin{t})+e^{-2t}(\cos{t}+4\sin{t})}$$
