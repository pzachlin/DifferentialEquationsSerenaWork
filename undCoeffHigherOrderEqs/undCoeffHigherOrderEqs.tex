...
$$
In \href{https://xerxes.ximera.org/differentialequations/main/higherOrderConstCoeff/higherOrderConstCoeff}{Section 9.2} we learned how to find $y_c$. Here
we
...
method that we used in \href{https://xerxes.ximera.org/differentialequations/main/undeterminedCoeff/undeterminedCoeff}{Section 5.4} and
\href{https://xerxes.ximera.org/differentialequations/main/undeterminedCoeff/undeterminedCoeff2}{Section 5.5}, and is again called
\dfn{method of undetermined coefficients}. Since
the underlying ideas are the same as those in
\href{https://xerxes.ximera.org/differentialequations/main/undeterminedCoeff/undeterminedCoeff}{Section 5.4} and
\href{https://xerxes.ximera.org/differentialequations/main/undeterminedCoeff/undeterminedCoeff2}{Section 5.5},
