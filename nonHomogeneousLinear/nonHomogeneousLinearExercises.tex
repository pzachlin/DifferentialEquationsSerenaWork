...
A particular solution is $y_p=\answer{-1+2x+3x^2}$
The General solution is $y=\answer{-1+2x+3x^2}+c_1\answer{e^{-6x}}+c_2\answer{e^x}$
...
$y_p=\answer{\frac{1}{x^3}}$ is a particular solution.
...
$y_p=\answer{e^{-3x}}$ is a particular solution.
...
\begin{solution}
If $y_p=A\cos x+B\sin x$ then $y_p''+y_p=-(A\cos x+B\sin x)+(A\cos x+B\sin x)=0$ for any constants $A$ and $B$
\end{solution}
...
$y_p=y_{p_1}+y_{p_2}=\answer{-1+2x+3x^2+\frac{e^{3x}}{3}}$ is a particular solution.

$y=\answer{-1+2x+3x^2+\frac{e^{3x}}{3}}+c_1\answer{e^{-6x}}+c_2\answer{e^x}$ is a general solution.
