...
$$f(t)=\answer{\frac{1}{2}t^3e^{7t}}$$
    
    \item $\frac{2s-4}{s^2-4s+13}$

$$f(t)=\answer{2e^{2t}\cos(3t)}$$
    
    \item $\frac{1}{s^2+4s+20}$

$$f(t)=\answer{\frac{1}{4}e^{-2t}\sin(4t)}$$
    
    \item $\frac{2}{s^2+9}$

$$f(t)=\answer{\frac{2}{3}\sin(3t)}$$
...
$$f(t)=\answer{\frac{1}{2}e^{2t}\sinh(2t)}$$
    
    \item $\frac{12s-24}{(s^2-4s+85)^2}$

$$f(t)=\answer{\frac{2}{3}e^{2t}t\sin(9t)}$$
  
    \item $\frac{2}{(s-3)^2-9}$

$$f(t)=\answer{\frac{2}{3}e^{3t}\sinh(3t)}$$
 
    \item $\frac{s^2-4s+3}{(s^2-4s+5)^2}$

$$f(t)=\answer{e^{2t}t\cos{t}}$$
...
$$f(t)=\answer{\frac{1}{4}e^{2t}-\frac{1}{4}e^{-2t}-e^{-t}}$$

    \item $\frac{7+(s+4)(18-3s)}{(s-3)(s-1)(s+4)}$
    
$$f(t)=\answer{\frac{1}{5}e^{-4t}-\frac{41}{5}e^{t}+5e^{3t}}$$

    \item $\frac{2+(s-2)(3-2s)}{(s-2)(s+2)(s-3)}$
    
$$f(t)=\answer{-\frac{1}{2}e^{2t}-\frac{13}{10}e^{-2t}-\frac{1}{5}e^{3t}}$$

    \item $\frac{3-(s-1)(s+1)}{(s+4)(s-2)(s-1)}$

$$f(t)=\answer{-\frac{2}{5}e^{-4t}-\frac{3}{5}e^{t}}$$

\item $\frac{3+(s-2)(10-2s-s^2)}{(s-2)(s+2)(s-1)(s+3)}$

$$f(t)=\answer{\frac{3}{20}e^{2t}-\frac{37}{12}e^{-2t}+\frac{1}{3}e^{t}+\frac{8}{5}e^{-3t}}$$
    
\item $\frac{3+(s-3)(2s^2+s-21)}{(s-3)(s-1)(s+4)(s-2)}$

$$f(t)=\answer{\frac{39}{10}e^{t}+\frac{3}{14}e^{3t}+\frac{23}{105}e^{-4t}-\frac{7}{3}e^{2t}}$$
\end{enumerate}
\end{problem}
...
$$f(t)=\answer{\frac{3}{5}\cos(2t)+\frac{1}{5}\sin(2t)-\frac{3}{5}\cos(3t)-\frac{2}{15}\sin(3t)}$$
    
    \item $\frac{-4s+1}{(s^2+1)(s^2+16)}$
    
$$f(t)=\answer{-\frac{4}{15}\cos{t}+\frac{1}{15}\sin{t}+\frac{4}{15}\cos(4t)-\frac{1}{60}\sin(4t)}$$
    
    \item $\frac{5s+3}{(s^2+1)(s^2+4)}$

$$f(t)=\answer{\frac{5}{3}\cos{t}+\sin{t}-\frac{5}{3}\cos(2t)-\frac{1}{2}\sin(2t)}$$
    
    \item $\frac{-s+1}{(4s^2+1)(s^2+1)}$

$$f(t)=\answer{-\frac{1}{3}\cos{\frac{t}{2}}+\frac{2}{3}\sin{\frac{t}{2}}+\frac{1}{3}\cos{t}-\frac{1}{3}\sin{t}}$$
    
    \item $\frac{17s-34}{(s^2+16)(16s^2+1)}$

$$f(t)=\answer{\frac{1}{15}\cos(\frac{t}{4})-\frac{8}{15}\sin(\frac{t}{4})-\frac{1}{15}\cos(4t)+\frac{1}{30}\sin(4t)}$$
    
    \item $\frac{2s-1}{(4s^2+1)(9s^2+1)}$

$$f(t)=\answer{\frac{2}{5}\cos(\frac{t}{3})-\frac{3}{5}\sin(\frac{t}{3})-\frac{2}{5}\cos(\frac{t}{2})+\frac{2}{5}\sin(\frac{t}{2}})$$
...
$$f(t)=\answer{\frac{e^t}{16}(1-\cos(4t))}$$
    
    \item $\frac{3s+2}{(s-2)(s^2+2s+10)}$

$$f(t)=\answer{\frac{4}{9}e^{2t}-\frac{4}{9}e^{-t}\cos(3t)+\frac{5}{9}e^{-t}\sin(3t)}$$
    
    \item $\frac{34-17s}{(2s-1)(s^2-2s+5)}$

$$f(t)=\answer{3e^{\frac{t}{2}}-3e^t\cos(2t)-\frac{7}{2}e^t\sin(2t)}$$
    
    \item $\frac{s+2}{(s-3)(s^2+2s+5)}$

$$f(t)=\answer{\frac{1}{4}e^{3t}-\frac{1}{4}e^{-t}\cos(2t)}$$
    
    \item $\frac{2s-2}{(s-2)(s^2+2s+10)}$

$$f(t)=\answer{\frac{1}{9}e^{2t}-\frac{1}{9}e^{-t}\cos(3t)+\frac{5}{9}e^{-t}\sin(3t)}$$
