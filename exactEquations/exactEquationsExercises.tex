...
$M(x,y)=14x^2y^3$;\;
$N(x,y)=21 x^2y^2$;\;
$M_y(x,y)=\answer{42x^2y^2}$;\;
$N_x(x,y)=\answer{42xy^2}$;\;
so the equation \wordChoice{\choice{IS}, \choice[correct]{IS NOT}} exact.
\end{problem}
...
$M(x,y)=3x^2+2xy+4y^2$;\;
$N(x,y)=x^2+8xy+18y$;\;
$M_y(x,y)=\answer{2x+8y}$;\;
$N_x(x,y)=\answer{2x+8y}$;\;
so the equation \wordChoice{\choice[correct]{IS}, \choice{IS NOT}} exact.
\begin{question}
    The solution to this exact equation can be written as $\answer{x^3+x^2y+4xy^2+9y^2}=c$
\end{question}
\end{problem}
...
$M(x,y)=x^2e^{x^2+y}(2x^2+3)+4x$\;
$N(x,y)=x^3e^{x^2+y}-12y^2$\;
$M_y(x,y)=\answer{e^{x^2+y}(2x^4+3x^2)}$\;
$N_x(x,y)=\answer{e^{x^2+y}(2x^4+3x^2)}$\;
so the equation \wordChoice{\choice[correct]{IS}, \choice{IS NOT}} exact.
\begin{question}
    The solution to this exact equation can be written as $\answer{x^3e^{x^2+y}-4y^3+2x^2}=c$
\end{question}
\end{problem}
...
$N(x,y)=\cos x$\;
$M_y(x,y)=\answer{-\sin x}$\;
$N_x(x,y)=\answer{-\sin x}$\;
so the equation \wordChoice{\choice[correct]{IS}, \choice{IS NOT}} exact.
\begin{question}
    The implicit solution to this exact equation can be written as $\answer{-\cos x+y\cos x-2\sin x}=\answer{0}$
\end{question}
...
The solution to this exact equation can be written as $\answer{\frac{x^4y^4}{4}+x^2+\frac{3y^2}{2}}=c$
