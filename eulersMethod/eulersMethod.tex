...
y=\frac{e^{-2x}}{4}(x^4+4),
\end{equation}
which can be obtained by the method of \href{https://xerxes.ximera.org/differentialequations/main/separableEquations/separableEquations}{Section 2.1}. (Verify.)
