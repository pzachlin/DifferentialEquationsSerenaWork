...
$y=c_1\answer{e^{-3x}\cos x}+c_2\answer{e^{-3x}\sin x}$ is the general solution.
...
$y'(0)=\answer{\frac{1}{3}}c_1+\answer{\frac{-1}{2}}c_2=3$

Therefore $y=\answer{3e^{\frac{x}{3}}-4e^{\frac{-x}{2}}}$ is the solution to the initial value problem.
...
$y=\answer{e^{7x-7}(2-3(x-1))}$ is the solution to the intermediate value problem.
...
\begin{eqnarray*}
y&=&c_1e^{r_1(x-x_0)}+c_2e^{r_2(x-x_0)}\\
y'&=&r_1c_1e^{r_1(x-x_0)}+r_2 c_2e^{r_2(x-x_0)}.
\end{eqnarray*}
...
\frac{k_1-r_1k_0}{r_2-r_1}e^{r_2(x-x_0)}\\
