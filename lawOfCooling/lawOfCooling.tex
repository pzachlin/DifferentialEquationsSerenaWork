        ...
        \begin{axis}[
          ...
          xtick={5,10,15,20,25,30},
           ...
           ytick={50,100,150,200,250, 300,350,400},
            yticklabels={$50$,$100$,$150$,$200$,$250$,$300$, $350$, $400$},  
            axis x line=center,
            axis y line=center,
            xlabel={$t$},
            ylabel={$T$},
...
\addplot[smooth, thick, blue] {25+375*exp((-x/4)*ln(15/7))};
\addplot[smooth, thick, dashed, blue] {25};
      \end{axis}
        \end{tikzpicture}
\end{center}
...
\addplot[smooth, thick, blue] {-20+80*exp((-x/2)*ln(8/7))};
\addplot[smooth, thick, dashed, blue] {-20};
  \draw[dashed] (-2.1,0) -- (-2.1,72);
  \draw[dashed] (-2.1,72) -- (0,72);
  \node[anchor=west] at (0,72) {$T=72$};
  \node[anchor=north] at (-2.1,0) {$-2.09$};
