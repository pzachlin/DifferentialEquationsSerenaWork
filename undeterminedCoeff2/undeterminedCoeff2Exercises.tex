...
$y_p=\answer{e^x(-2\cos x+3\sin x)}$ is a particular solution.
\end{problem}
...
$y_p=\answer{x(x\cos (\frac{x}{2})-3\sin (\frac{x}{2}))}$ is a particular solution.
\end{problem}
...
$y_p=\answer{e^x(x^2\cos x+2\sin x)}$ is a particular solution.
\end{problem}
