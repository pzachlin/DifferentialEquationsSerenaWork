...
For an analog of this theorem that is applicable to $\eqref{eq:5.5.1}$, see Exercise~\ref{exer:5.5.38}.
...
solutions of the complementary equation for $\eqref{eq:5.5.5}$. We are
...
\begin{explanation}
The coefficients of $\cos x$ and $\sin x$ in $\eqref{eq:5.5.7}$ are polynomials of degree one and zero, respectively. Therefore
...
polynomials multiplying $\cos x$. (An analogous result applies in general, see Exercise~\ref{exer:5.5.36}).
...
this approach you will see that deriving $\eqref{eq:5.5.22}$ this way is much more tedious than the way we did it in Example~\ref{example:5.5.6}.
